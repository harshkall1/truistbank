        ...
        <div className="account-container">
            <div className="account-header page-bx">
                <div className="top-header">
                    <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/8/8b/Truist_Financial_logo.svg/2560px-Truist_Financial_logo.svg.png" alt="logo" className="logo" />
